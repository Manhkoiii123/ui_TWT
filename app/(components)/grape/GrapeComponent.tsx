                        ...
                        <tr style="width: 100%">
                          <td data-id="__react-email-column">
                            <h1
                              ...
                              "
                            >
                              Hi, <span id="name">${data.name}</span>
                            </h1>
                            <h2
                              style="
                                font-size: 26px;
                            ...
                            <p
                              ...
                              "
                            >
                              <b>Time: </b> <span id="time">${data.time}</span>
                            </p>
                            <p
                              style="
                                font-size: 16px;
...
`;
  ...
  console.log("🚀 ~ GrapeComponent ~ selectedId:", selectedId);
  ...
  useEffect(() => {
    ...
    editor.on("component:selected", (component) => {
      ...
      const tableId = wrapper?.find(`#${blockId}`)[0];
      const spanComponents = tableId?.find('[id="name"]')[0];
      if (spanComponents) {
        spanComponents.set("content", "Tên mới");
      }
